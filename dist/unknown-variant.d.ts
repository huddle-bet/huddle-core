 ...
 */
export declare function assertKnownVariant<T extends string | number>(category: string, value: T, known: ReadonlySet<T> | ReadonlyArray<T>, opts?: AssertKnownVariantOptions): boolean;
/**
 ...
 */
export declare function _resetAssertKnownVariantCache(): void;
//# sourceMappingURL=unknown-variant.d.ts.map