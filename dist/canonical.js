 ...
 * fixed.
 */
export function canonicalEventId(key) {
    if (!key.teamIdA || !key.teamIdB) {
        throw new Error(`canonicalEventId requires both team IDs — got teamIdA=${key.teamIdA}, teamIdB=${key.teamIdB}`);
    }
 ...
 */
export function liveChannelName(fixtureId) {
