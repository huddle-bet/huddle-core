...
export function getBaseShrink(league, stat, side) {
    if (side) {
 ...
 */
export function applyShrinkage(rawProb, baseShrink) {
 ...
 */
export function toAsciiOdds(american) {
    return american.replace(/[\u2212\u2013\u2014]/g, '-');
}
/** Convert American odds to implied probability (no-vig) */
export function oddsToImpliedProb(american) {
...
export function oddsToDecimalPayout(american) {
    const num = parseInt(toAsciiOdds(american).replace(/[^-\d]/g, ''));
    if (isNaN(num) || num === 0)
        return null;
    if (num > 0)
 ...
 */
export function probOver(projected, stdDev, line, statType, expectedValue) {
    /**
...
//# sourceMappingURL=win-probability.js.map