...
import { americanToDecimal, decimalToAmerican, impliedProbability, devig, vig, expectedValue, kellyFraction, OddsError, } from '../betting/odds.js';
...
describe('parlay', () => {
    ...
    it('devigs when every leg brings its opposite, and finds a non-zero hold', () => {
        const r = parlay([{ odds: -110, oppositeOdds: -110 }, { odds: -110, oppositeOdds: -110 }], 100);
...
//# sourceMappingURL=calculators.test.js.map